...
function Edit(props) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.PanelColorSettings, {
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Color Settings", "gutenberg-demo"),
    icon: "admin-appearance",
    initialOpen: false,
    colorSettings: [{
      value: backgroundColor,
      onChange: onChangeBackgroundColor,
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Background Color", "gutenberg-demo")
    }, {
      value: textColor,
      onChange: onChangeTextColor,
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Text Color", "gutenberg-demo")
    }]
    ...
    value: text,
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Your text"),
    tagName: "h4",
  ...
  transforms: {
    from: [{
      ...
      transform: _ref => {
        ...
        return (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.createBlock)("create-block/gutenberg-demo", {
          text: content,
          alignment: align
        });
      }
...
function save(_ref) {
  ...
  const {
    ...
    textColor,
    shadow
  } = attributes; // const classes = classnames(`text-box-align-${alignment}`);
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"create-block/gutenberg-demo","version":"0.1.0","title":"Gutenberg Demo","category":"widgets","icon":"admin-generic","description":"A box of text","keywords":["text","paragraph","box"],"supports":{"html":false},"styles":[{"name":"squared","label":"Squared","isDefault":true},{"name":"rounded","label":"Rounded"}],"example":{"attributes":{"text":"This is some text!","gradient":"red-to-blue","shadow":true}},"textdomain":"gutenberg-demo","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkgutenberg_demo"] = self["webpackChunkgutenberg_demo"] || [];
